Feature: Login Test With Excel File
  ...
  Scenario Outline: Login Test
    ...
    Then The user verifies success login with file:"<path>" and "<sheetName>" and <row>
    Examples:
      | path                                  | sheetName | row |
      ...
      | src/test/resources/LoginList_New.xlsx | QaTeam2   | 9   |
      | src/test/resources/LoginList.xlsx     | QaTeam2   | 10  |
      | src/test/resources/LoginList.xlsx     | QaTeam3   | 0   |
      | src/test/resources/LoginList_New.xlsx | QaTeam3   | 1   |
  ...
  Scenario Outline: Login Test -3
    ...
    Examples:
      ...
      | src/test/resources/LoginList_New.xlsx | QaTeam1   |
      | src/test/resources/LoginList_New.xlsx | QaTeam2   |
      | src/test/resources/LoginList_New.xlsx | QaTeam3   |
