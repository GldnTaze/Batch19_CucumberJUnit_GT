...
public class Dashboard_StepDefs {
    ...
    @Then("The user should verify the dashboard tabswith follows")
    public void the_user_should_verify_the_dashboard_tabswith_follows(List<String>dashboardTabTexts) {
        List<String> actualTabsTexts = dashboardPage.getDashboardTabsTexts();
        Assert.assertEquals(dashboardTabTexts,actualTabsTexts);
