...
public class UserProfile_StepDefs {
    ...
    //    List<String> addEducationFormLabelsTexts = addEducationPage.getAddEducationFormLabelsTexts();
    //    Assert.assertEquals(labels,addEducationFormLabelsTexts);
    ...
    public void the_user_verifies_that_add_education_page_is_displayed() {
        addEducationPage.verifyEducationPageIsDisplay();
